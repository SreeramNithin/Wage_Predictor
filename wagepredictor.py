...
# Merge the two dataframes based on iso_code column
...
fig = px.choropleth(geo_df, locations='iso_a3', color='Wage(in Euro)', hover_name='Nationality', projection='natural earth',color_continuous_scale='Greens')
fig.update_layout(
